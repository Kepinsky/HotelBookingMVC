...
namespace HotelBookingMVC.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StartDate,EndDate,RoomId,UserId")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StartDate,EndDate,RoomId,UserId")] Reservation reservation)
        {
